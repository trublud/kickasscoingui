...
<context>
    ...
    <message>
        ...
        <translation>KickAssCoinを送ったり受け取ったりするのが簡単になり、アドレスを手で打ち間違えるのを避けられます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告: キーの再利用に関する対策が組み込まれていない限り、KickAssCoinのキーを別のフォークで使い回さないでください。あなたのプライバシーが損なわれます。</translation>
    </message>
    <message>
        ...
        <translation>警告: シードをクリップボードにコピーすると、シードを記録しKickAssCoinを盗む悪意あるソフトウェアに晒される可能性があります。シードは手で書き留めてください。</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some KickAssCoin. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>自分のコンピュータでマイニングをすることでKickAssCoinネットワークをより強固にできます。多くの人がマイニングをすればするほど、攻撃はより難しくなります。

マイニングをするとKickAssCoinが手に入ることがあります。コンピュータはブロックの解となるハッシュ値を生成し、もしブロックを見つけたら報酬が手に入ります。グッドラック！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ウォレットデバイスのパスフレーズを入力してください: </translation>
    </message>
    <message>
        <location filename="../components/PassphraseDialog.qml" line="111"/>
        <source>Please enter wallet device passphrase</source>
        <translation>ウォレットデバイスのパスフレーズを入力</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ウォレットの切り替え</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>組み込まれているKickAssCoinのバージョン: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>サードパーティーのサーバを使ってKickAssCoinネットワークに接続します。セキュリティは低くなりますがより簡単です。</translation>
    </message>
    <message>
        ...
        <translation>リモートノードを見つけるには、お好きな検索エンジンで&apos;KickAssCoin remote node&apos;と検索してください。ノードが信頼できるサードパーティーによって運営されていることを確認してください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このページでは共有リングデータベースを操作できます。このデータベースはKickAssCoinウォレットおよびKickAssCoinのキーを再利用するKickAssCoinクローンのウォレットで利用するためのものです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、KickAssCoinトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、KickAssCoinが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはKickAssCoinプロジェクトによって保守されgetkickasscoin.orgのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはkickasscoin-blockchain-mark-spent-outputsというツールを使い、KickAssCoinのブロックチェーン(およびキーを再利用するKickAssCoinクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>KickAssCoinのリング署名による保護を無効化しないため、あるアウトプットを使う際に異なるブロックチェーンで異なるリングを使うことは避けなければなりません。これは通常問題になりませんが、キーを再利用するKickAssCoinクローンが既存のアウトプットの使用を許している場合問題になります。この場合、既存のアウトプットは両方のチェーンで同じリングを使わなくてはなりません。&lt;br&gt;これはキーを再利用するソフトウェアが積極的にプライバシーを侵害しようとしない限り自動的に行われます。&lt;br&gt;もしキーを再利用するKickAssCoinクローンを使っていてそのクローンがこの保護を含んでいない場合も、まずクローンの方でアウトプットを使用しその後リングをこのページに手動で追加することで、トランザクションは保護されKickAssCoinを安全に使用できるようになります。&lt;br&gt;これらの機能を提供しないキーを再利用するKickAssCoinクローンを使用していない場合、すべては自動化されているので何もする必要はありません。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>キーを再利用するチェーンでアウトプットに使用されたリングを記録し、プライバシーの問題を避けるためKickAssCoinでも同じリングを使うようにします。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>KickAssCoinアドレス (例: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>KickAssCoinの送金に成功しました</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>パスワードは復元できません。忘れた場合ウォレットは25語のニーモニックシードから復元する必要があります。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>KickAssCoinネットワークとやりとりするにはウォレットをKickAssCoinノードに接続する必要があります。プライバシーのためにはあなた自身がノードを走らせることを推奨します。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>KickAssCoinをすぐに使いたい場合ブートストラップノードを指定できます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>KickAssCoinへようこそ。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>もしKickAssCoinを使うのが初めてならこのオプションを選んでください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ハードウェアウォレットを接続して新しいKickAssCoinウォレットを作成</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>KickAssCoin GUIの言語を変更</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>(&lt;i&gt;ブートストラップ&lt;/i&gt;という名前が示すように)リモートノードを一時的に使用することはKickAssCoinをすぐに使うのに便利です。ただしリモートノードを使う場合(ブートストラップ設定時を含む)、ノードはあなたのIPアドレスや&quot;復元を開始するブロック高&quot;とそれに付随するブロック要求データを追跡でき、あなたが送る取引についてより知るために正確でない情報を送ってくる可能性があります。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このモードは少額のKickAssCoinを扱う場合に適しています。取引を作成したり管理したりする基本的な機能にアクセスできます。KickAssCoinネットワークに自動的に接続するためKickAssCoinをすぐに使い始めることができます。</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>KickAssCoinネットワークとやりとりするためウォレットはKickAssCoinノードに接続する必要があります。プライバシーのため自分自身でノードを走らせることを推奨します。
...
<context>
    ...
    <message>
        ...
        <translation>ウォレットの場所</translation>
    </message>
    <message>
...
金額: </translation>
    ...
    <message>
        ...
        <translation>このアドレスは%1mKIKを受け取りましたが、取引はまだ承認されていません。</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1057"/>
        <source>This address received %1 kickasscoin, with %2 confirmation(s).</source>
        <translation>このアドレスは%1mKIKを受け取り、その取引は%2回承認されました。</translation>
    </message>
    <message>
...
ペイメントID: </translation>
    ...
    <message>
        ...
        <translation>残高 (#%1%2)</translation>
    </message>
    <message>
...
手数料: </translation>
    ...
    <message>
        ...
        <translation>KickAssCoinの送金に成功しました: %1 トランザクション</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>新しいバージョンの KickAssCoin v.%1 が利用可能です。&lt;br&gt;&lt;br&gt;ダウンロード:&lt;br&gt;%2&lt;br&gt;&lt;br&gt;SHA256ハッシュ:&lt;br&gt;%3</translation>
    </message>
    <message>
        <location filename="../main.qml" line="2161"/>
        <source>New version of KickAssCoin is available. Check out getkickasscoin.org</source>
        <translation>新しいバージョンのKickAssCoinが利用可能です。getkickasscoin.orgをチェックしてください。</translation>
    </message>
    <message>
